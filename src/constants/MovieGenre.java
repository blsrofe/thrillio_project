...
public class MovieGenre {
    ...
    public static final String SPECAIL_INTEREST = "Special Interest";
    ...
    public static final String CLASSIC_MOVIE_MUSCICALS = "Classic Movie Musicals";
    ...
    public static final String FOREIGN_ACTION_AND_ADVENTURE = "Foreign Action and Adventure";
